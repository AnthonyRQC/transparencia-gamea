      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/10 font-sans">
        <PublicHeader
          acciones={
            <Link
              href={route('home')}
              className="px-4 py-1.5 rounded-full bg-sidebar-muted text-sidebar-foreground border border-sidebar-border text-xs sm:text-sm font-bold shadow-md hover:bg-sidebar-muted/70 transition-all duration-200 flex items-center gap-1.5"
            >
