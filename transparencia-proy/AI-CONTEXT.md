...
**Estado inmediato:** **16.1 ✅ + 16.2 ✅ cerrados** (17-sep-2026: `can:` + `CasoAuth` + locks + split rutas + admin seed; 133 tests + tsc + build verdes; visual light/dark pendiente). Siguiente: **Sprint 18A — Panel Usuarios**.
...
> - Permisos personalizados por usuario (granulares) → Sprint 25 (**parcialmente adelantado en Sprint 18C: delegaciones temporales auditadas**)
